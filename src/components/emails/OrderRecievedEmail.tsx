...
const OrderRecieveEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === 'development'
      ? 'http://localhost:3000'
      : 'https://phone-case-sepia.vercel.app';
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              your package has been shipped. Delivery usually takes 2 of 3 days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions regarding your Phone Case order, please
              feel free to contact us with your order number and we're here to
              help.
            </Text>
          </Section>
