...
export default function Home() {
  return (
    <div className='bg-slate-50'>
      <section>
        <MaxWidthWrapper className='sm:pd-32 pb-24 pt-10 lg:grid lg:grid-cols-3 lg:gap-x-0 lg:pb-52 lg:pt-24 xl:gap-x-8 xl:pt-32'>
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            <div className='relative mx-auto flex flex-col items-center text-center lg:items-start lg:text-left'>
              <div className='absolute -top-16 left-0 hidden w-24 lg:block'>
                <Link href={'/'}>
                  <img
                    src='/snake-1.png'
                    alt='logo Case Cobra'
              ...
              <p className='max mt-8 max-w-prose text-balance text-center text-lg md:text-wrap lg:pr-10 lg:text-left'>
                Capture your favorite memories with your own,{' '}
                <span className='font-semibold'>one-of-one</span> phone case.
                CaseCobra allows you to prottect your memories, not juwst your
                phone case.
              </p>
              <ul className='item-center mt-8 flex flex-col space-y-2 text-left font-medium sm:items-start'>
      ...
      <section className='p-y-24 bg-slate-100'>
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-col items-center gap-4 sm:gap-6 lg:flex-row'>
            <h2 className='order-1 mt-2 text-balance pb-4 pt-3 text-center text-5xl font-bold !leading-tight tracking-tight md:text-6xl'>
              What our{' '}
              <span className='relative px-2'>
                customers
                <Icons.underline className='pointer-events-none absolute -inset-x-2 -bottom-8 hidden text-violet-500 sm:block' />
              </span>{' '}
              say
            </h2>
          </div>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 gap-y-16 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              <div className='mb-2 flex gap-0.5'>
                <Star className='h-5 w-5 fill-violet-600 text-violet-600' />
                <Star className='h-5 w-5 fill-violet-600 text-violet-600' />
                <Star className='h-5 w-5 fill-violet-600 text-violet-600' />
                <Star className='h-5 w-5 fill-violet-600 text-violet-600' />
                <Star className='h-5 w-5 fill-violet-600 text-violet-600' />
      ...
      <section>
        <MaxWidthWrapper className='py-24'>
          <div className='mb-12 px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl sm:text-center'>
              <h2 className='order-1 mt-2 text-balance text-center text-5xl font-bold !leading-tight tracking-tight text-gray-900 md:text-6xl'>
                ...
                <span className='relative bg-violet-500 px-2 text-white'>
                  your own case
                </span>{' '}
                now
              </h2>
          ...
          <ul className='mx-auto mt-12 w-fit max-w-prose space-y-2 sm:text-lg'>
            <li className='w-fit'>
              <Check className='mr-1.5 inline h-5 text-violet-600' />
              Hight-quality Silicone material!
            </li>
            <li className='w-fit'>
              <Check className='mr-1.5 inline h-5 text-violet-600' />5 year
              print warranty.
            </li>
            <li className='w-fit'>
              <Check className='mr-1.5 inline h-5 text-violet-600' />
