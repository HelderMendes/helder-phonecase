...
-- CreateEnum
CREATE TYPE "PhoneCaseModel" AS ENUM ('iphonex', 'iphone11', 'iphone12', 'iphone13', 'iphone14', 'iphone15');

-- CreateEnum
CREATE TYPE "PhoneCaseMaterial" AS ENUM ('silicone', 'polycarbonate');

-- CreateEnum
CREATE TYPE "PhoneCaseFinish" AS ENUM ('smooth', 'textured');

-- CreateEnum
CREATE TYPE "PhoneCaseColor" AS ENUM ('black', 'blue', 'rose', 'violet', 'yellow', 'teal');
